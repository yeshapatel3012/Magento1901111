<?php
class Ys_MagecomOneStepCheckout_Model_Observers_SortFields extends Mage_Core_Model_Abstract {
    ...
    public function applyFieldOrder(Varien_Event_Observer $observer) {
        ...
        //config varialbes
        $sort = Mage::getStoreConfig('magecomonestepcheckout/sortordering_fields');
        $whitelist = $this->getWhiteList(Mage::getStoreConfig('magecomonestepcheckout/exclude_fields'));
