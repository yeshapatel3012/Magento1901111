 ...
 *
 */
class Ys_MagecomOneStepCheckout_Block_Checkout extends Mage_Checkout_Block_Onepage_Abstract  {
    ...
    const SESSION_ADDRESS_CHECK_NAME = 'magecomonestepcheckout_address_check_name';
    ...
    public function _handlePostData()
    {
        ...
        if( $this->_isLoggedInWithAddresses() && false )    {
            ...
            $checkoutHelper = Mage::helper('magecomonestepcheckout/checkout');
            ...
            if(!$this->_isLoggedIn()){
                ...
                if($registration_mode == 'auto_generate_account')   {
                    ...
                    $password = Mage::helper('magecomonestepcheckout/checkout')->generatePassword();
            ...
            if($this->differentShippingAvailable()) {
                if(!isset($billing_data['use_for_shipping']) || $billing_data['use_for_shipping'] != '1')   {
                    ...
                    $shipping_result = Mage::helper('magecomonestepcheckout/checkout')->saveShipping($shipping_data, $shippingAddressId);
                    ...
                    $shipping_result = Mage::helper('magecomonestepcheckout/checkout')->saveShipping($billing_data, $customerAddressId);
                }
            }
        }
        ...
        if(!$this->isVirtual() )  {
            ...
            $result = Mage::helper('magecomonestepcheckout/checkout')->saveShippingMethod($shipping_method);
            if(isset($result['error']))    {
                $this->formErrors['shipping_method'] = true;
            }
            else    {
        ...
        try {
            ...
            $result = Mage::helper('magecomonestepcheckout/checkout')->savePayment($payment);
