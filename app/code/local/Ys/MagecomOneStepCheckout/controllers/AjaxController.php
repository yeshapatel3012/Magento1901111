<?php
class Ys_MagecomOneStepCheckout_AjaxController extends Mage_Core_Controller_Front_Action
{
    public function add_extra_productAction()
    {
        $helper = Mage::helper('magecomonestepcheckout/extraproducts');
    ...
    public function add_couponAction()
    {
        ...
        ->setTemplate('magecomonestepcheckout/shipping_method.phtml')
        ->toHtml();
        ...
        ->setTemplate('magecomonestepcheckout/payment_method.phtml');

        if(Mage::helper('magecomonestepcheckout')->isEnterprise() && Mage::helper('customer')->isLoggedIn()){

            if (Mage::helper('magecomonestepcheckout')->hasEeCustomerbalanace()) {
                $customerBalanceBlock = $this->getLayout()->createBlock('enterprise_customerbalance/checkout_onepage_payment_additional', 'customerbalance', array(
                    'template' => 'magecomonestepcheckout/customerbalance/payment/additional.phtml'
                ));
                $customerBalanceBlockScripts = $this->getLayout()->createBlock('enterprise_customerbalance/checkout_onepage_payment_additional', 'customerbalance_scripts', array(
                    'template' => 'magecomonestepcheckout/customerbalance/payment/scripts.phtml'
                ));
                $this->getLayout()
        ...
        if (Mage::helper('magecomonestepcheckout')->isEnterprise() && Mage::helper('magecomonestepcheckout')->hasEeGiftcards()) {
            $giftcardScripts = $this->getLayout()->createBlock('enterprise_giftcardaccount/checkout_onepage_payment_additional', 'giftcardaccount_scripts', array(
                'template' => 'magecomonestepcheckout/giftcardaccount/onepage/payment/scripts.phtml'
            ));
        ...
        $html = $this->getLayout()
        ->createBlock('magecomonestepcheckout/summary')
        ->setTemplate('magecomonestepcheckout/summary.phtml')
        ->toHtml();
    ...
    public function loginAction()
    {
        ...
        $username = $this->getRequest()->getPost('magecomonestepcheckout_username', false);
        $password = $this->getRequest()->getPost('magecomonestepcheckout_password',  false);
