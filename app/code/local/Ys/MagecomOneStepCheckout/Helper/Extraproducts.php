<?php
class Ys_MagecomOneStepCheckout_Helper_Extraproducts extends Mage_Core_Helper_Abstract
{
    function getProductIds()
    {
        $ids_raw = Mage::getStoreConfig('magecomonestepcheckout/extra_products/product_ids');
